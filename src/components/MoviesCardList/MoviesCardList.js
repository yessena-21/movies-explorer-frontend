...
function MoviesCardList({ movies, windowWidth, handleSaveMovie, handleDeleteMovie, moviesMessage,isLiked, isSaved }) {
    ...
    return (
        <section className="movies-card-list">
            ...
            <LoadMore onMoreClick={handleMoreClick} isButtonActive={isButtonActive}></LoadMore>
        </section>
    )
